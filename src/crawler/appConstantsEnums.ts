export const mySignatureTokens = (process.env.MY_SIGNATURE_TOKEN || '').split('|||').filter((r) => !!r);
...
export enum REDIS_KEY {
  ...
  QUEUE_FETCH_RAW_CONTENT_THREAD_ID = 'QUEUE_FETCH_RAW_CONTENT',
  QUEUE_PARSE_EMAIL_THREAD_ID = 'QUEUE_PARSE_EMAIL',
  QUEUE_UPLOAD_EMAILS_MESSAGE_ID = 'QUEUE_UPLOAD_EMAILS_BY_MESSAGE_ID',
  QUEUE_SKIPPED_MESSAGE_ID = 'QUEUE_SKIPPED_MESSAGE_ID',
  QUEUE_IN_PROGRESS_THREAD_ID = 'QUEUE_IN_PROGRESS_THREAD_ID',
  QUEUE_IN_PROGRESS_MESSAGE_ID = 'QUEUE_IN_PROGRESS_MESSAGE_ID',
